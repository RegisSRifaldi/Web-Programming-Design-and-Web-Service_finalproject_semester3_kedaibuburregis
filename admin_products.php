...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" min="0" class="box" required max="9999999999" placeholder="masukan harga produk" onkeypress="if(this.value.length == 10) return false;" name="price">
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="admin_products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('hapus produk ini?');">delete</a>
      </div>
   </div>
   <?php
         }
