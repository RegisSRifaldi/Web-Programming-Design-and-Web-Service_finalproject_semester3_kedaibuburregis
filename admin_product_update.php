...
<section class="update-product">
   ...
   <form action="" enctype="multipart/form-data" method="post">
      ...
      <input type="text" class="box" required maxlength="100" placeholder="masukan nama produk" name="name" value="<?= $fetch_products['name']; ?>">
      <input type="number" min="0" class="box" required max="9999999999" placeholder="masukan harga produk" onkeypress="if(this.value.length == 10) return false;" name="price" value="<?= $fetch_products['price']; ?>">
