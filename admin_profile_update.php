...
<head>
   ...
   <title>admin perbaharui profile</title>
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" required placeholder="masukan nama anda" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      ...
      <input type="submit" value="Perbarui sekarang" class="btn" name="update">
   </form>
